module.exports = {
    ...
    body: p => {
        const standard = `module ComboDiode (layer F.Cu) (tedit 5B24D78E)
    ...
    `
        ...
        const via = `
        (pad 1 thru_hole circle (at 2.65 0) (size 0.6 0.6) (drill 0.3) (layers *.Cu) (zone_connect 2) ${p.net.from.str})
        (pad 2 thru_hole circle (at -2.65 0) (size 0.6 0.6) (drill 0.3) (layers *.Cu) (zone_connect 2) ${p.net.to.str})
        `
        return `(${standard}
